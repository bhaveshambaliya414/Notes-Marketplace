            ...
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="birth-date" class="form-control" id="date" placeholder="Enter your date of birth">
                    </div>
                    <div class="form-group col-md-6">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="file" class="form-control-file image-upload1" id="profile-picture" required>
                    </div>
