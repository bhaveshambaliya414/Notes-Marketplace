                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="sell-btn">
                                ...
                                <button type="submit" name="publish"  href="dashboard.php" class="btn btn-sell" <?php if($isflag == 0) { echo 'disabled';} else {echo 'enabled';} ?> >PUBLISH</button>
                            </div>
                        </div>
