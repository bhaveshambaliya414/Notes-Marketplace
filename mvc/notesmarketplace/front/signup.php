...
if(isset($_POST['submit'])) {
    ...
    if($result>0) {
        ...
        if($password === $cpassword){
            ...
            $insertquery = "INSERT INTO users ( roleid, firstname, lastname, email, password, token ,isemailverified, createddate, createdby, modifieddate, modifiedby, isactive) VALUES ('1', '$firstname', '$lastname', '$email', '$pass', '$token', b'0', NULL, NULL, NULL, NULL, b'1')";    
