...
if (isset($_POST['download'])) {
    ...
    $selectquery = "SELECT * FROM sellernotes";
...
<body>
    ...
    <section id="note-details">
        <div class="content-box">
            ...
            <div class="container">
            <form action="notedetails.php" method="post">
                <div class="row">
