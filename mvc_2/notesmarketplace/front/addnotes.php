...
if (isset($_POST['submit'])) {
    ...
    if($notequery){
        ...
        $_SESSION['title'] = $title;
        $_SESSION['uploadnote'] = $uploadnote; 
        $attech = "INSERT INTO `sellernotesattachments`(`noteid`, `filename`, `filepath`, `createddate`, `createdby`, `modifieddate`, `modifiedby`, `isactive`) VALUES ('$last_id', '$title', '$uploadnote', NULL, NULL, NULL, NULL, b'0')";
