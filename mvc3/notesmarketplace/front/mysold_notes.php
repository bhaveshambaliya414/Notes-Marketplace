...
<body>
        ...
        <div class="content-box">
            ...
            <div class="container">
                ...
                <div class="row table-general table-responsive">
                    <table class="table table-hover" id="soldnotes_table">
                        <thead>
                        <tr>
                        ...
                        <tbody>
                        <?php
                        $select = "SELECT * FROM downloads WHERE issellerhasalloweddownload = 1 AND seller = $user_id AND downloader != $user_id GROUP BY noteid,downloader ORDER BY attachmentdownloadeddate DESC";
                        $downdata = mysqli_query($conn,$select);
                        $scount = mysqli_num_rows($downdata);
                        ...
                        <tr>
                            <td><?php echo $i; ?></td>
                            <td><a class="mysoldnote" name="mysoldnote" href="notedetails.php?id=<?php echo $noteid; ?>" role="button"><?php echo $notedata['title']; ?></a></td>
                            <td><?php
    ...
    <script>
        $(document).ready(function() {
            var table = $('#soldnotes_table').DataTable({
                'sDom': '"top"i',
                "iDisplayLength": 10,
                language: {
                    paginate: {
