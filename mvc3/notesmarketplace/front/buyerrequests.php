            ...
            <div class="container">
                ...
                <div class="row table-general table-responsive">
                    <table class="table table-hover" id="buyer_table">
                        ...
                        <tbody>
                        <?php
                        $select = "SELECT * FROM downloads WHERE issellerhasalloweddownload = 0 AND ispaid = 1 AND downloader != $userid AND seller = $userid GROUP BY noteid,downloader ORDER BY attachmentdownloadeddate DESC";
                                ...
                                <a href="notedetails.php?id=<?php echo $noteid; ?>"><img src="images/Dashboard/eye.png" alt="view" class="eye"></a>
                                    <div class="btn-group dropleft">
                                        ...
                                        <div class="dropdown-menu">
                                            <!-- Dropdown menu links -->
                                            <a href="buyermail.php?id=<?php echo $noteid; ?>">Allow Download</a>
                                        </div>
                                    </div>    
                            </td>
                        </tr>
