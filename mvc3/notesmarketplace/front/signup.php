            ...
            <div class="row justify-content-center">
                <div class="form-content">
                    ...
                    <p class="text-center success">
                        <i class="fa fa-check-circle" aria-hidden="true"></i> Your account has been successfully created.</p> 
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input id="password" type="password" class="form-control" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[^a-zA-Z0-9])(?!.*\s).{6,24}" title="Must contain at least one number and one uppercase one special character and lowercase letter, and at least 6 or more characters" name="password" placeholder="Enter your Password" required>
                            
                        </div>

                        <div class="form-group">
                            <label for="con_password">Confirm Password</label>
                            <input id="c_password" type="password" class="form-control" name="cpassword" placeholder="Enter your Password" required>
                            
                        </div>

                        <button type="submit" name="submit" class="btn signup-btn" onclick="return validation()">Sign Up</button>
