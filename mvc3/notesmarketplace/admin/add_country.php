...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        $insertquery = "INSERT INTO `countries`(`name`, `countrycode`, `createddate`, `createdby`, `modifieddate`, `modifedby`, `isactive`) VALUES ('$countryname','$countrycode',current_timestamp(),NULL,current_timestamp(),NULL,b'1')";
        $countryquery = mysqli_query($conn, $insertquery);
    }
    ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="countryname" class="form-control" id="country-name" placeholder="Enter country name">
                        </div>
                        <div class="form-group">
                            <label for="country code">Country Code *</label>
                            <input type="text" name="countrycode" class="form-control" id="country-code" placeholder="Enter country code">
                        </div>
                    </div>
                </div>
                <div class="row">
