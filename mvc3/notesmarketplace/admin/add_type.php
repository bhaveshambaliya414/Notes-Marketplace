...
<body>
    ...
    if (isset($_POST['submit'])) {
        ...
        $insertquery = "INSERT INTO `notetypes`(`name`, `description`, `createddate`, `createdby`, `modifieddate`, `modifedby`, `isactive`) VALUES ('$typename','$description',current_timestamp(),NULL,current_timestamp(),NULL,b'1')";
        $typequery = mysqli_query($conn, $insertquery);
    }
    ?>
