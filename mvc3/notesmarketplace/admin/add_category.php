...
<!-- Navigation  -->
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item profile-dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    ...
                                    <a class="dropdown-item logout" href="../front/login.php">Logout</a>
                                </div>
                            </li>
                            <li class="nav-item"><a class="nav-link" href="../front/login.php">Logout</a></li>
                        </ul>
    ...
    if (isset($_POST['submit'])) {
        ...
        $insertquery = "INSERT INTO `notecategories`(`name`, `description`, `createddate`, `createdby`, `modifieddate`, `modifedby`, `isactive`) VALUES ('$categoryname','$description',current_timestamp(),NULL,current_timestamp(),NULL,b'1')";
        $categoryquery = mysqli_query($conn, $insertquery);
    }
    ?>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="categoryname" class="form-control" id="category-name" placeholder="Enter your category name">
                        </div>
                        <div class="form-group">
