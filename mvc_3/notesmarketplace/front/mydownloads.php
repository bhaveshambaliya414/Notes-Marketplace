                                ...
                                <td>
                                    ...
                                    <div class="btn-group dropleft">
                                        ...
                                        <div class="dropdown-menu">
                                            <!-- Dropdown menu links -->
                                            <a target="_blank" href="notedetails.php?id=<?php echo $noteid; ?>">Download Note</a>
                                            ...
                                            <h5 class="modal-title" id="reviewmodal">
                                                <div class="row">
                                                    ...
                                                    <fieldset class="rate">
                                                        ...
                                                        <input type="radio" id="star<?php echo $i; ?>4half" name="rate1" value="4.5" /><label class="half" for="star<?php echo $i; ?>4half" title="4.5 stars"></label>
                                                        <input type="radio" id="star<?php echo $i; ?>4" name="rate1" value="4" /><label class="full" for="star<?php echo $i; ?>4" title="4 stars"></label>
                                                        <input type="radio" id="star<?php echo $i; ?>3half" name="rate1" value="3.5" /><label class="half" for="star<?php echo $i; ?>3half" title="3.5 stars"></label>
                                                        <input type="radio" id="star<?php echo $i; ?>3" name="rate1" value="3" /><label class="full" for="star<?php echo $i; ?>3" title="3 stars"></label>
                                                        <input type="radio" id="star<?php echo $i; ?>2half" name="rate1" value="2.5" /><label class="half" for="star<?php echo $i; ?>2half" title="2.5 stars"></label>
                                                        <input type="radio" id="star<?php echo $i; ?>2" name="rate1" value="2" /><label class="full" for="star<?php echo $i; ?>2" title="2 stars"></label>
                                                        <input type="radio" id="star<?php echo $i; ?>1half" name="rate1" value="1.5" /><label class="half" for="star<?php echo $i; ?>1half" title="1.5 stars"></label>
                                                        <input type="radio" id="star<?php echo $i; ?>1" name="rate1" value="1" /><label class="full" for="star<?php echo $i; ?>1" title="1 star"></label>
                                                        <input type="radio" id="star<?php echo $i; ?>half" name="rate1" value="0.5" /><label class="half" for="star<?php echo $i; ?>half" title="0.5 stars"></label>
                                                    </fieldset>
                                                </div>
                                            </h5>
