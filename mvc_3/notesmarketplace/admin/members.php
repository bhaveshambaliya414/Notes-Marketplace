                ...
                <div class="row table-general table-responsive">
                    <table class="table table-hover" id="member_table">
                        ...
                        <tr>
                            ...
                            <td>Khayati</td>
                            <td>Patel</td>
                            <td>khayati23@gmail.com</td>
                            <td>09/10/2020,10:10</td>
                            <td class="color-blue text-center">19</td>
                            <td class="color-blue text-center">10</td>
                            <td class="color-blue text-center">22</td>
                            <td class="color-blue text-center">$220</td>
                        ...
                        <tr>
                            ...
                            <td class="color-blue text-center">5</td>
                            <td class="color-blue text-center">4</td>
                            <td class="color-blue text-center">$232</td>
                        ...
                        <tr>
                            ...
                            <td>Suman</td>
                            <td>Trivedi</td>
                            <td>suman43@gmail.com</td>
                            <td>11-10-2020,01:00</td>
                            <td class="color-blue text-center">12</td>
                            <td class="color-blue text-center">11</td>
                            <td class="color-blue text-center">7</td>
                            <td class="color-blue text-center">$886</td>
                        ...
                        <tr>
                            ...
                            <td>Raj</td>
                            <td>Malhotra</td>
                            <td>rajm123@gmail.com</td>
                            <td>13-10-2020,10:10</td>
                            <td class="color-blue text-center">2</td>
                            <td class="color-blue text-center">13</td>
                            <td class="color-blue text-center">123</td>
                            <td class="color-blue text-center">$323</td>
                        ...
                        <tr>
                            ...
                            <td class="color-blue text-center">20</td>
                            <td class="color-blue text-center">1</td>
